    ...
    await sendEmail({
      ...
      html: `
        <div style="font-family: 'Inter', 'Helvetica Neue', Helvetica, Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #ffffff; padding: 40px 20px;">
          ...
          <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 20px;">
            Thank you for reaching out to LiftmyGrade. We have successfully received your readiness assessment submission.
          </p>
          <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 30px;">
            Our expert mentors are reviewing your profile and will get back to you within <strong>48 hours</strong> with a personalized pathway.
          </p>
