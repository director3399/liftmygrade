    ...
    <section className="py-24 px-6 md:px-12 bg-[#050B1D] rounded-[2.5rem] md:rounded-[4rem] mx-4 md:mx-12 text-white overflow-hidden my-12" id="event">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="relative flex items-center justify-center gap-6 md:gap-10 mb-16 overflow-visible">
          {/* Main Focused Card */}
          <div className="relative w-full max-w-[800px] h-[400px] md:h-[500px] rounded-4xl overflow-hidden group shadow-2xl z-20">
            <Image
              src={events[0].image}
              alt={events[0].title}
              fill
            ...
            />
            {/* Overlay Gradient */}
            <div className="absolute inset-0 bg-linear-to-t from-blue-600/90 via-transparent to-transparent" />
          ...
          {/* Side Card (Right) */}
          <div className="hidden lg:block relative w-[400px] h-[450px] rounded-4xl overflow-hidden opacity-40 hover:opacity-60 transition-opacity transform translate-x-4">
            <Image
              src={events[1].image}
              alt={events[1].title}
              fill
          ...
          {/* Side Card (Left - Peek) */}
          <div className="hidden lg:block absolute left-0 w-[400px] h-[450px] rounded-4xl overflow-hidden opacity-40 transform -translate-x-full">
            <Image
              src={events[2].image}
              alt={events[2].title}
              fill
