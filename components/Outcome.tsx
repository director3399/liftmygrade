...
export default function Outcome() {
  const items = [
    ...
    {
      id: "02",
      title: "Stronger Research Positioning",
  ...
  return (
    <section className="py-24 px-6 md:px-12 bg-white" id="outcome">
      <div className="max-w-7xl mx-auto">
        ...
        <div className="grid md:grid-cols-2 gap-12 mb-16">
          ...
          <div className="flex flex-col items-start justify-end">
            <p className="text-base text-neutral-500 leading-relaxed max-w-[320px] mb-8">
        ...
        <div className="flex flex-col">
          {items.map((item, index) => (
            <div
              key={index}
              className={`grid md:grid-cols-2 gap-12 md:gap-24 py-20 items-stretch border-b border-neutral-200`}
            >
              <div className={`${item.reverse ? "md:order-last" : ""} flex flex-col justify-between py-2`}>
                ...
                <div className="content-block mt-12 md:mt-0">
                  <p className="text-lg text-neutral-500 leading-relaxed font-light max-w-lg mb-8">
                    {item.desc}
                  </p>
                  ...
                  <div className="flex flex-wrap gap-3">
                    {item.tags.map((tag, tIndex) => (
                      <span
                        key={tIndex}
                        className="px-5 py-2 border border-neutral-300 rounded-full text-sm text-neutral-500 font-medium hover:bg-neutral-50 transition-colors cursor-default"
                      >
                        {tag}
                      </span>
                    ))}
