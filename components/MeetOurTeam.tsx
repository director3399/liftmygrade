      ...
      <div className="max-w-6xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="flex flex-col gap-4">
            <div 
              className="relative rounded-4xl sm:rounded-[32px] overflow-hidden h-[250px] sm:h-[300px] md:h-[340px] w-full"
            >
            ...
            <div 
              className="rounded-4xl sm:rounded-[32px] bg-white p-6 sm:p-8 flex flex-col min-h-[200px] md:h-[220px]"
            >
          ...
          <div className="flex flex-col gap-4">
            <div 
              className="order-2 md:order-1 rounded-4xl sm:rounded-[32px] bg-white p-6 sm:p-8 flex flex-col min-h-[200px] md:h-[220px]"
            >
            ...
            <div 
              className="order-1 md:order-2 relative rounded-4xl sm:rounded-[32px] overflow-hidden h-[250px] sm:h-[300px] md:h-[340px] w-full"
            >
