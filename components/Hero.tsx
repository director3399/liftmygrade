    ...
    <section className="relative min-h-screen pt-32 px-6 md:px-12 lg:px-16 pb-24 flex items-end bg-[#0a0a0a] overflow-hidden" id="hero">
      ...
      <div className="relative z-20 max-w-7xl mx-auto w-full grid lg:grid-cols-[1.7fr_0.9fr] gap-12 items-end">
        ...
        <div className="hero-text-left relative flex flex-col items-start">
          ...
          >
            Not Sure Where To <span className="relative inline-block whitespace-nowrap z-10 px-1">
            ...
            </span> Your <br className="hidden md:inline" />
            <span className="text-transparent bg-clip-text bg-linear-to-r from-blue-400 via-blue-200 to-white">Study Abroad Journey?</span>
          </motion.h1>
          ...
          >
            From choosing the right country to building a strong profile, we help students navigate every stage of studying abroad with clarity, planning, and step-by-step mentorship.
          </motion.p>
            ...
            <div className="bg-white/5 backdrop-blur-md border border-white/10 rounded-2xl p-6 shadow-2xl">
              ...
              <div className="relative rounded-xl overflow-hidden h-[180px] group cursor-pointer">
                ...
                <div className="absolute bottom-0 left-0 right-0 p-5 z-20">
                  <h3 className="text-xl font-semibold text-white mb-1 leading-tight tracking-tight">
                    Country Selection
                    <br />
                    Mentorship
                  </h3>
                  <span className="text-[11px] text-white/60 font-bold tracking-widest uppercase">Academic Planning</span>
                </div>
              </div>
            </div>
          </div>
